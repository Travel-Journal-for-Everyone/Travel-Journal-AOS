...
fun SearchBarButtonComponent(
    ...
    Row(
        ...
        modifier = modifier.clickable { onClicked(placeholder) }.fillMaxWidth().background(color = Gray06).padding(horizontal = 20.dp, vertical = 12.dp),
    ){
        Text(
            text = placeholder,
